...
function genQuestion1osa(progressInt) {
    let number1 = pickRandomNumber(0, 12);
    ...
    return logCheckRep(answer, questionText, genQuestion1osa, progressInt);
}

function genQuestion2osa(progressInt) {
    return genQuestion1osa(10);
}

function genQuestion3osa() {
    return genQuestion1osa(100);
}
